...
public class SkinManager1 : MonoBehaviourPun
{
    ...
    void Start()
    {
       ...
       int slotinPlayercount = PlayerController.instance.selectPlayerCount;
        //GameObject clone = Instantiate(prefab, SpawnPosiotion[0].position, Quaternion.identity);
        GameObject prefab = characterPrefab[slotinPlayercount];

        //PhotonNetwork.LocalPlayer.ActorNumber
        clone = new GameObject[PhotonNetwork.CurrentRoom.PlayerCount];
        PhotonNetwork.Instantiate(prefab.name, SpawnPosiotion[PhotonNetwork.LocalPlayer.ActorNumber - 1].position, Quaternion.identity, 0, new object[]
             {
        ...
        //{
        //    print(prefab.name);
        //     clone[i] = PhotonNetwork.Instantiate(prefab.name, SpawnPosiotion[i].position, Quaternion.identity, 0, new object[]
        //     {
        //         PhotonNetwork.LocalPlayer.ActorNumber,
        ...
        //    //Instantiate(prefab, SpawnPosiotion[i].position, Quaternion.identity);
        //}
